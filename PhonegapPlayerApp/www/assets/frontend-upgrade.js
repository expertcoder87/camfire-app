...
define('frontend-upgrade/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend-upgrade","environment":"development","rootURL":"","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"HOST":"http://localhost:4200","FAYE_URL":"http://localhost:9292","name":"frontend-upgrade","version":"0.0.0+29b49c22","rootElement":"body"},"fastboot":{"hostWhitelist":["localhost",{}]},"exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("frontend-upgrade/app")["default"].create({"HOST":"http://localhost:4200","FAYE_URL":"http://localhost:9292","name":"frontend-upgrade","version":"0.0.0+29b49c22","rootElement":"body"});
}
